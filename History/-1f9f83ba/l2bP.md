...
Die Maschinendaten werden dem System somit manuell zugeführt. Die Benutzerschnittstelle wurde mittels Kommandozeile auf Basis einer flexiblen Konfigurationsdatei erstellt. <!-- TODO Beschreibung -->
...
<!-- TODO -->
Ziel des AP 2.1 ist das Körperschallübertragungsverhalten der Versuchsanlage, beschrieben durch 
Eigenfrequenzen, Dämpfungen und Eigenschwingformen, mittels einer experimentellen Modalana-
lyse zu beschreiben, um so die idealen Sensorpositionen zu ermitteln. Eine ideale Sensorposition 
beschreibt in diesem Zusammenhang einen Ort an der Struktur der Versuchsanlage, der durch sehr 
große Schwingungsamplituden bezüglich vieler Eigenfrequenzen gegenzeichnet ist. Aus den Ergeb-
nissen werden anschließend Positionen bzw. Komponenten der Anlage für die Sensorintegration 
und Körperschallmessung bestimmt.

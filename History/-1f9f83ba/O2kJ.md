...
Die OPC-UA-Schnittstelle wird zu einem Interface abstrahier und durch MQTT ersetzt. <!-- TODO Plausible Gründe angeben -->
...
<!-- TODO Zusammenfassung und Update--> Schädigungen am Draht werden zum 1. Messtermin aufgezeichnet, diese sind aufgrund von Messsystemgrenzen nur bis 50 kHz auswertbar. Für folgende Messtermine wird das CMSMesssystem eingesetzt. Die synthetisch erzeugten Störungen sind dennoch bereits sehr gut ersichtlich (vgl. Spektrale_Leistungsdichte_Vgl_mit_ohne_Störung.png).

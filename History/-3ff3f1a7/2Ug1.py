...
@router.get("/secure/apikey/", dependencies=[Depends(authify)])
async def test_api_key(api_key: APIKey = Depends(get_current_user)):
    return {"entered api key": api_key, "status": "ok"}

...
def app() -> None:
    ...
    if not df.empty:
        ...
        with st.form("EditMeta"):
            ...
            hourrate = col5.number_input("Stundensatz", value=30.0, min_value=0.0, max_value=100.0)
            data = {
                "workhours": workhours,
                "workdays": workdays,
                "province": province,

...
![Niederfrequente Schwigungsphänomene im Überblick [@pischingerViewegHandbuchKraftfahrzeugtechnik2016] \label{swing} ](images/Schwingungsph%C3%A4nomene.png){ width=100mm height=80mm }
...
![Ordnungsanalyse am Motorgeräusch [@pischingerViewegHandbuchKraftfahrzeugtechnik2016] \label{motor}](images/Motorger%C3%A4usch.png){ width=100mm height=80mm }
...
![Schwingbeschleunigung an der Sitzschiene [@pischingerViewegHandbuchKraftfahrzeugtechnik2016] \label{bamp}](images/Sitzschiene.png){ width=120mm height=80mm }

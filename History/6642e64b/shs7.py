...
class Requestor:
    ...
    def get_from_query(self, query: str) -> requests.models.Response:
        """Return the response of a get method"""

        request_response = self.s.get(
            f"{self.url}{query}",
        )
        return request_response

    def post_query(self, query: str, data_dict: dict) -> requests.models.Response:
    ...
    def delete_query(self, query:str) -> requests.models.Response:
        

    # def login(self) -> None:
    #     """"Call the specific login method"""
    #     self.special_session.login()

...
class Requestor:
    ...
    def get_from_query(self, endpoint: str) -> requests.models.Response:
    ...
    def delete_query(self, endpoint: str, filt: dict = {}) -> requests.models.Response:

        request_response = self.s.delete(
            f"{self.url}{endpoint}",
            data=filt,
        )

...
f = FileHandler("cacert.pem")

server = "prod"

urls = {
    "dev": "https://ace-lounge-dev.cnap-00-mp-dev3.bmwgroup.net/api/v1",
    "prod": "https://ace-lounge-pro.cnap-00-mp-prod.bmwgroup.net/api/v1",
}
...
class JWTSession:
    """Creates a jwt connection to the ACE-Lounge and test several get and post requests"""

    authServer = "https://auth.bmwgroup.net/auth/json/realms/root/realms/intranetb2x"
    headers = {
        "accept": "text/plain",
        "Content-Type": "application/json",
    }

    def __init__(self, user="", password="", baseurl=urls[server]):

        self.server = server
        self.url = baseurl
        self.uID, self.pID = getWindowsPassword()
        self.s = requests.Session()

        # TODO Is there any cookie in my Users Folder?

...
import os
from matplotlib.pyplot import savefig, xlabel, ylabel, subplot, grid, plot, ylim, xlim, figure, show
import sys
import warnings
...
class Ui_FRF_Analyzer(object):
    ...
    def get_all_peaks(self):
        ...
        #find peaks
        self.x_peak, _ = find_peaks(self.feature,
    ...
    def add_list_items(self):
        ...
        '''
        items = [f'{self.peaks[i]}Hz-err:{round(self.peaks[i],3)}'

...
![Boxplot der Features des ersten Auswertungsdesigns beim Ultrasc \label{boxplot_base.pdf}](images/boxplot_base.pdf){ width=100% }
...
![Boxplot der Features des zweiten Datensamples \label{boxplot.pdf}](images/boxplot.pdf){ width=100% }

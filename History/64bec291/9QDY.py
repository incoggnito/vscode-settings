...
if __name__ == "__main__":
    ...
    f = FileHandler("*", wkd=r"C:\Users\ahofer\Desktop\INTEUM\00_Messungen_03_05_2022")

    for subfld, files in f.get_all_subfolders():
        f = FileHandler("*", subdir=files)
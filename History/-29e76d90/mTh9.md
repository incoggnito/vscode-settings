...
Bei fehlenden Daten im NVH-Bereich wird zu Beginn geprüft ob bereits ein Versuchsaufbau vorhanden ist. Fehlt ein Testaufbau, so ist es meist notwendig den Anregungsmechanismus und die Wirkweise grob zu verstehen. Ein vollständiges Verständnis des Wirkmechanismus ist meist kostenaufwendig und wird auf das notwendige Umfänge begrenzt. Sobald alle Randbedingungen bekannt sind und die Sensoren und Messsysteme ausgewählt wurden kann eine Messung durchgeführt werden. Oftmals werden hier Echtzeitanalyse Werkzeuge eingesetzt um die Dauer der Iterationsschleifen gering zu halten.

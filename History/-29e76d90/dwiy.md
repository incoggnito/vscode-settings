...
In Vorbereitung für den Use Case Lagerschaden am Elektromotor, wird bereits frühzeitig das VAM-System mit den Acoustic Emission Sensoren auf dem Elektromotors positioniert. Der kurze Test soll zeigen, wie die spektrale Signatur des Elektromotors beim Anfahren aussieht. 
...
<!-- TODO Abgleich mit Fahrbewegung -->
...
Die Auswirkungen vom Einbringen einer Unwucht werden wie in Abschnitt XX durch Auswertung von Spektrogrammen bzw. entsprechende Ordnungsanalysen durchgeführt. Das in Abbildung XX dargestellte Spektrogramm zeigt, die dominierende Raddrehzahl näherungsweise als Konstante im bei einer Frequenz. Im Diagramm werden vier verschiedene Unwucht und Geschwindigkeitspaarungen vergleichen. Es wird erwartet, dass bei höherer Unwucht und höherer Geschwindigkeit die Beschleunigungsamplitude am Sensor durch zunehmende Vibrationen zunimmt. Diese zunehmende Amplitude lässt sich durch eine Ordnungsanalyse am besten auswerten. Aufgrund des fehlenden Drehzahlkanals in den Busdaten wird hier ein virtueller Drehzahlkanal berechnet werden, welcher als Referenz für die erste Ordnung dient.
